 ...
 */
public class UserInterfaceImp implements IUserInterfaceContract.View, EventHandler<KeyEvent> {

    private final Stage stage;
    private final Group root;

    //This HashMap stores the Hash Values of each TextField by their Coordinates. When a SudokuGame
    ...
    private void drawTextFields(Group root) {
        ...
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                ...
                //Note: that UserInterfaceImpl implements EventHandler<ActionEvent> in the class declaration.
                //By passing "this", when an action occurs,
    ...
    private void drawGridLines(Group root) {
        ...
        int index = 0;
        while (index < 8) {
            // Lines need to be thicker between Sudoku blocks
            int thickness;
            if (index == 2 || index == 5) {
                thickness = 3;
            } else {
